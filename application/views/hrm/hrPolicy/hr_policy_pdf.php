<html>
    <head>
        <title><?php $fileName = $employeeData['employee_first_name'].' '.$employeeData['employee_middle_name'].' '.$employeeData['employee_last_name']; echo "$fileName - HR POLICY"; ?></title>
        <style>
            @page{
        ...
        <main>
            <?php
                ...
                echo str_replace(array(
                    ...
                    $pageBreak,
                    $pdfHrPolicy['effective_date']
                ),$pdfHrPolicy['hr_policy_letter']); 
            ?>
        </main>
    </body>
</html>