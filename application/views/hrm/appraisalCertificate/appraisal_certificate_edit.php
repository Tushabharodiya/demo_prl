            ...
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    ...
                    <div class="nk-block-des text-soft">
                        <p>Edit Appraisal Certificate</p>
                    </div>
                </div>
                <div class="nk-block-head-content">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    ...
                                    <input type="text" class="form-control date-picker" name="effective_date" value="<?php echo $appraisalCertificateData['effective_date']; ?>" placeholder="Enter effective date" data-date-format="dd/mm/yyyy" autocomplete="off" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    ...
                                    <input type="text" class="form-control date-picker" name="create_date" value="<?php echo $appraisalCertificateData['create_date']; ?>" placeholder="Enter create date" data-date-format="dd/mm/yyyy" autocomplete="off" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
