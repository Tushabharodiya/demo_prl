                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    ...
                                    <input type="text" class="form-control date-picker" name="from_date" value="<?php echo $experienceData['from_date']; ?>" placeholder="Enter from date" data-date-format="dd/mm/yyyy" autocomplete="off" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    ...
                                    <input type="text" class="form-control date-picker" name="to_date" value="<?php echo $experienceData['to_date']; ?>" placeholder="Enter to date" data-date-format="dd/mm/yyyy" autocomplete="off" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    ...
                                    <input type="text" class="form-control date-picker" name="create_date" value="<?php echo $experienceData['create_date']; ?>" placeholder="Enter create date" data-date-format="dd/mm/yyyy" autocomplete="off" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
