        ...
        <div class="nk-block-head">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h4 class="title nk-block-title">Termination</h4>
                    <div class="nk-block-des text-soft">
                        <p>Edit Termination</p>
                    </div>
                </div>
                <div class="nk-block-head-content">
                    <a href="<?php echo $_SERVER['REQUEST_URI']; ?>" class="btn btn-outline-light bg-white d-block d-sm-inline-flex"><em class="icon ni ni-arrow-left"></em></a>
                </div>
            </div>
        </div>
            ...
            <div class="card-inner">
                <form action="" method="post" class="form-validate is-alter" enctype="multipart/form-data">
                    <div class="row g-gs">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="form-label" for="termination_reason">Termination Reason *</label>
                                <div class="form-control-wrap">
                                    <textarea class="tinymce-default form-control" name="termination_reason" required><?php echo $terminationData['termination_reason']; ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    ...
                                    <input type="text" class="form-control date-picker" name="create_date" value="<?php echo $terminationData['create_date']; ?>" placeholder="Enter create date" data-date-format="dd/mm/yyyy" autocomplete="off" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
