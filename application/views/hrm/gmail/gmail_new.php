                    ...
                    <div class="row g-gs">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" name="gmail_mail_id" placeholder="Enter gmail mail id" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" name="gmail_password" placeholder="Enter gmail password" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" name="figma_password" placeholder="Enter figma password" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
