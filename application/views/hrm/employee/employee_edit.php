                ...
                <form action="" method="post" class="nk-stepper stepper-init form-validate is-alter" id="stepper-two-factor-auth" enctype="multipart/form-data">
                    <div class="nk-stepper-content">
                        <div class="nk-stepper-steps stepper-steps">
                                ...
                                <div class="row g-gs">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" name="employee_first_name" value="<?php echo $employeeData['employee_first_name']; ?>" placeholder="Enter employee first name" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" name="employee_middle_name" value="<?php echo $employeeData['employee_middle_name']; ?>" placeholder="Enter employee middle name" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" name="employee_last_name" value="<?php echo $employeeData['employee_last_name']; ?>" placeholder="Enter employee last name" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="email" class="form-control" name="employee_email" value="<?php echo $employeeData['employee_email']; ?>" placeholder="Enter employee email" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <textarea type="text" class="form-control" name="employee_correspondence_address" placeholder="Enter employee correspondence address" required><?php echo $employeeData['employee_correspondence_address']; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <textarea type="text" class="form-control" name="employee_permanent_address" placeholder="Enter employee permanent address" required><?php echo $employeeData['employee_permanent_address']; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="number" class="form-control" name="employee_telephone_no" value="<?php echo $employeeData['employee_telephone_no']; ?>" placeholder="Enter employee telephone no">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="number" class="form-control" name="employee_mobile_no" value="<?php echo $employeeData['employee_mobile_no']; ?>" placeholder="Enter employee mobile no" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="text" class="form-control date-picker" name="employee_birth_date" value="<?php echo $employeeData['employee_birth_date']; ?>" placeholder="Enter employee birth date" data-date-format="dd/mm/yyyy" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <select class="form-control form-select js-select2" name="employee_blood_group" data-placeholder="Select a group" required>
                                                    <option value="A+"<?php if($employeeData['employee_blood_group'] =="A+"){ echo "selected"; } else { echo ""; } ?>>A+</option>
                                                    <option value="A-"<?php if($employeeData['employee_blood_group'] =="A-"){ echo "selected"; } else { echo ""; } ?>>A-</option>
                                                    <option value="B+"<?php if($employeeData['employee_blood_group'] =="B+"){ echo "selected"; } else { echo ""; } ?>>B+</option>
                                                    <option value="B-"<?php if($employeeData['employee_blood_group'] =="B-"){ echo "selected"; } else { echo ""; } ?>>B-</option>
                                                    <option value="O+"<?php if($employeeData['employee_blood_group'] =="O+"){ echo "selected"; } else { echo ""; } ?>>O+</option>
                                                    <option value="O-"<?php if($employeeData['employee_blood_group'] =="O-"){ echo "selected"; } else { echo ""; } ?>>O-</option>
                                                    <option value="AB+"<?php if($employeeData['employee_blood_group'] =="AB+"){ echo "selected"; } else { echo ""; } ?>>AB+</option>
                                                    <option value="AB-"<?php if($employeeData['employee_blood_group'] =="AB-"){ echo "selected"; } else { echo ""; } ?>>AB-</option>
                                                    <option value="None"<?php if($employeeData['employee_blood_group'] =="None"){ echo "selected"; } else { echo ""; } ?>>None</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <select class="form-control form-select js-select2" name="employee_marital_status" data-placeholder="Select a status" required>
                                                    <option value="Unmarried"<?php if($employeeData['employee_marital_status'] =="Unmarried"){ echo "selected"; } else { echo ""; } ?>>Unmarried</option> 
                                                    <option value="Married" <?php if($employeeData['employee_marital_status'] =="Married"){ echo "selected"; } else { echo ""; } ?>>Married</option>
                                                    <option value="Engaged"<?php if($employeeData['employee_marital_status'] =="Engaged"){ echo "selected"; } else { echo ""; } ?>>Engaged</option> 
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" name="employee_emergency_contact_name" value="<?php echo $employeeData['employee_emergency_contact_name']; ?>" placeholder="Enter employee emergency contact name">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" name="employee_emergency_contact_relation" value="<?php echo $employeeData['employee_emergency_contact_relation']; ?>" placeholder="Enter employee emergency contact relation">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="number" class="form-control" name="employee_emergency_contact_no" value="<?php echo $employeeData['employee_emergency_contact_no']; ?>" placeholder="Enter employee emergency contact no">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="nk-stepper-step">
                                ...
                                <div id="educational_field">
                                    <?php
                                    $employeeEducationalDegree = explode('#',$employeeData['employee_educational_degree']);
                                    $employeeEducationalUniversityInstitute = explode('#',$employeeData['employee_educational_university_institute']);
                                    $employeeEducationalStartYear = explode('#',$employeeData['employee_educational_start_year']);
                                    $employeeEducationalEndYear = explode('#',$employeeData['employee_educational_end_year']);
                                    $employeeEducationalPercentageGrade = explode('#',$employeeData['employee_educational_percentage_grade']);
                                    $employeeEducationalSpecialisation = explode('#',$employeeData['employee_educational_specialisation']);
                                    foreach($employeeEducationalDegree as $key => $value) { ?>
                                    <div class="border mt-4" id="delete">
                                        <div class="card-inner">
                                            <div class="row g-gs">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control" name="employee_educational_degree[]" value="<?php echo $employeeEducationalDegree[$key]; ?>" placeholder="Enter employee educational degree">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control" name="employee_educational_university_institute[]" value="<?php echo $employeeEducationalUniversityInstitute[$key]; ?>" placeholder="Enter employee educational university institute">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control" id="yearpicker" name="employee_educational_start_year[]" value="<?php echo $employeeEducationalStartYear[$key]; ?>" placeholder="Enter employee educational start year" autocomplete="off">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control" id="yearpicker" name="employee_educational_end_year[]" value="<?php echo $employeeEducationalEndYear[$key]; ?>" placeholder="Enter employee educational end year" autocomplete="off">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control" name="employee_educational_percentage_grade[]" value="<?php echo $employeeEducationalPercentageGrade[$key]; ?>" placeholder="Enter employee educational percentage grade">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control" name="employee_educational_specialisation[]" value="<?php echo $employeeEducationalSpecialisation[$key]; ?>" placeholder="Enter employee educational specialisation">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <button type="button" class="btn btn-dim btn-sm btn-danger educational_remove mb-4" id="ml0" name="remove"><em class="icon ni ni-trash"></em><span>Remove</span></button>
                                    </div>
                                    <?php } ?>
                                </div>
                            ...
                            <div class="nk-stepper-step">
                                ...
                                <div id="employeement_field">
                                    <?php
                                    $employeeEmployeementOrganisation = explode('#',$employeeData['employee_employeement_organisation']);
                                    $employeeEmployeementDesignation = explode('#',$employeeData['employee_employeement_designation']);
                                    $employeeEmployeementStartDate = explode('#',$employeeData['employee_employeement_start_date']);
                                    $employeeEmployeementEndDate = explode('#',$employeeData['employee_employeement_end_date']);
                                    $employeeEemployeementAnnualCTC = explode('#',$employeeData['employee_employeement_annual_ctc']);
                                            ...
                                            <div class="row g-gs">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control" name="employee_employeement_organisation[]" value="<?php echo $employeeEmployeementOrganisation[$key]; ?>" placeholder="Enter employee employeement organisation">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control" name="employee_employeement_designation[]" value="<?php echo $employeeEmployeementDesignation[$key]; ?>" placeholder="Enter employee employeement designation">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control" id="datepicker" name="employee_employeement_start_date[]" value="<?php echo $employeeEmployeementStartDate[$key]; ?>" placeholder="Enter employee employeement start date" autocomplete="off">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control" id="datepicker" name="employee_employeement_end_date[]" value="<?php echo $employeeEmployeementEndDate[$key]; ?>" placeholder="Enter employee employeement end date" autocomplete="off">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control" name="employee_employeement_annual_ctc[]" value="<?php echo $employeeEemployeementAnnualCTC[$key]; ?>" placeholder="Enter employee employeement annual ctc">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <button type="button" class="btn btn-dim btn-sm btn-danger employeement_remove mb-4" id="ml0" name="remove"><em class="icon ni ni-trash"></em><span>Remove</span></button>
                                    </div>
                                    <?php } ?>
                                </div>
                            ...
                            <div class="nk-stepper-step">
                                ...
                                <div id="family_field">
                                    <?php
                                    $employeeFamilyMemberName = explode('#',$employeeData['employee_family_member_name']);
                                    $employeeFamilyMemberRelation = explode('#',$employeeData['employee_family_member_relation']);
                                    $employeeFamilyMemberOccupation = explode('#',$employeeData['employee_family_member_occupation']);
                                    $employeeFamilyMemberBirthDate = explode('#',$employeeData['employee_family_member_birth_date']);
                                            ...
                                            <div class="row g-gs">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control" name="employee_family_member_name[]" value="<?php echo $employeeFamilyMemberName[$key]; ?>" placeholder="Enter employee family member name">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control" name="employee_family_member_relation[]" value="<?php echo $employeeFamilyMemberRelation[$key]; ?>" placeholder="Enter employee family member relation">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control" name="employee_family_member_occupation[]" value="<?php echo $employeeFamilyMemberOccupation[$key]; ?>" placeholder="Enter employee family member occupation">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control" id="datepicker" name="employee_family_member_birth_date[]" value="<?php echo $employeeFamilyMemberBirthDate[$key]; ?>" placeholder="Enter employee family member birth date" autocomplete="off">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <button type="button" class="btn btn-dim btn-sm btn-danger family_remove mb-4" id="ml0" name="remove"><em class="icon ni ni-trash"></em><span>Remove</span></button>
                                    </div>
                                    <?php } ?>
                                </div>
                                <div class="col-sm-6 mt-4">
                            ...
                            <div class="nk-stepper-step">
                                ...
                                <div id="professional_field">
                                    <?php
                                    $employeeProfessionalReferenceName = explode('#',$employeeData['employee_professional_reference_name']);
                                    $employeeProfessionalReferenceOrganisation = explode('#',$employeeData['employee_professional_reference_organisation']);
                                    $employeeProfessionalReferenceDesignation = explode('#',$employeeData['employee_professional_reference_designation']);
                                    $employeeProfessionalReferenceContactNo = explode('#',$employeeData['employee_professional_reference_contact_no']);
                                            ...
                                            <div class="row g-gs">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control" name="employee_professional_reference_name[]" value="<?php echo $employeeProfessionalReferenceName[$key]; ?>" placeholder="Enter employee professional reference name">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control" name="employee_professional_reference_organisation[]" value="<?php echo $employeeProfessionalReferenceOrganisation[$key]; ?>" placeholder="Enter employee professional reference organisation">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control" name="employee_professional_reference_designation[]" value="<?php echo $employeeProfessionalReferenceDesignation[$key]; ?>" placeholder="Enter employee professional reference designation">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="number" class="form-control" name="employee_professional_reference_contact_no[]" value="<?php echo $employeeProfessionalReferenceContactNo[$key]; ?>" placeholder="Enter employee professional reference contact no">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <button type="button" class="btn btn-dim btn-sm btn-danger professional_remove mb-4" id="ml0" name="remove"><em class="icon ni ni-trash"></em><span>Remove</span></button>
                                    </div>
                                    <?php } ?>
                                </div>
                                <div class="col-md-6 mt-4">
                                ...
                                <div class="row g-gs">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" name="employee_place" value="<?php echo $employeeData['employee_place']; ?>" placeholder="Enter employee place" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" name="employee_signature" value="<?php echo $employeeData['employee_signature']; ?>" placeholder="Enter employee signature" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <ul class="nk-stepper-pagination pt-4 gx-4 gy-2 stepper-pagination">
                            ...
                            <li class="step-submit"><input type="submit" class="btn btn-primary submitBtn" name="submit" value="Update"></li>
                        </ul>
                    </div>
                </form>
            </div>
...
<script type="text/javascript">
    $(document).ready(function(){      
        ...
        $('body').on('click','.educational_remove',function() {
            var res = confirm('Are You Sure You Want To Delete This?');
            if(res==true){
        ...
        $('body').on('click','.employeement_remove',function() {
            var res = confirm('Are You Sure You Want To Delete This?');
            if(res==true){
                $(this).parent('#delete').remove()
            }
        ...
        $('body').on('click','.family_remove',function() {
            var res = confirm('Are You Sure You Want To Delete This?');
            if(res==true){
                $(this).parent('#delete').remove()
            }
        ...
        $('body').on('click','.professional_remove',function() {
            var res = confirm('Are You Sure You Want To Delete This?');
            if(res==true){
                $(this).parent('#delete').remove()
            }
