<?php
    $isSalaryAdd = checkPermission(HRM_SALARY_ALIAS, "can_add");
    $isSalaryView = checkPermission(HRM_SALARY_ALIAS, "can_view");
    $isSalaryEmailEdit = checkPermission(HRM_SALARY_EMAIL_ALIAS, "can_edit");
    $isSalaryEdit = checkPermission(HRM_SALARY_ALIAS, "can_edit");
    $isSalaryDelete = checkPermission(HRM_SALARY_ALIAS, "can_delete");
...
<div class="nk-content-wrap">
    <div class="nk-block nk-block-lg">
                            ...
                            <ul class="nk-block-tools g-3">
                                                        ...
                                                        <div class="row gx-6 gy-3">
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control form-select" id="search-email" name="search_salary_email" data-placeholder="Select a email">
                                                                        <?php $str='';
                                                                            if(!empty($sessionSalaryEmail == 'all')){
                                                                                $str.='selected';
                                                                        } ?> <option value="all"<?php echo $str; ?>>All</option>
                                                                        <?php $str='';
                                                                            if(!empty($sessionSalaryEmail == 'pending')){
                                                                                $str.='selected';
                                                                        } ?> <option value="pending"<?php echo $str; ?>>Pending</option>
                                                                        <?php $str='';
                                                                            if(!empty($sessionSalaryEmail == 'sending')){
                                                                                $str.='selected';
                                                            ...
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control form-select" id="search-type" name="search_salary_type" data-placeholder="Select a type">
                                                                        <?php $str='';
                                                                            if(!empty($sessionSalaryType == 'all')){
                                                                                $str.='selected';
                                                                        } ?> <option value="all"<?php echo $str; ?>>All</option>
                                                                        <?php $str='';
                                                                            if(!empty($sessionSalaryType == 'intern')){
                                                                                $str.='selected';
                                                                        } ?> <option value="intern"<?php echo $str; ?>>Intern</option>
                                                                        <?php $str='';
                                                                            if(!empty($sessionSalaryType == 'employee')){
                                                                                $str.='selected';
                                                            ...
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control form-select" id="search-status" name="search_salary_status" data-placeholder="Select a status">
                                                                        <?php $str='';
                                                                            if(!empty($sessionSalaryStatus == 'all')){
                                                                                $str.='selected';
                                                                        } ?> <option value="all"<?php echo $str; ?>>All</option>
                                                                        <?php $str='';
                                                                            if(!empty($sessionSalaryStatus == 'active')){
                                                                                $str.='selected';
                                                                        } ?> <option value="active"<?php echo $str; ?>>Active</option>
                                                                        <?php $str='';
                                                                            if(!empty($sessionSalaryStatus == 'inactive')){
                                                                                $str.='selected';
                                ...
                                <?php if(!empty($this->session->userdata['user_role'])){ ?>
                                    <?php if($this->session->userdata['user_role'] == "Super"){ ?>
                                        <li><a href="<?php echo base_url(); ?>view-trash-salary" class="btn btn-white btn-outline-light"><em class="icon ni ni-trash-fill"></em><span>Trash <sup><?php echo $countSalaryTrash; ?></sup></span></a></li>
                                    <?php } ?>
                                <?php } ?>
                                <?php if($isSalaryAdd){ ?>
                                    <li class="nk-block-tools-opt d-block d-sm-block">
                                        <a href="<?php echo base_url(); ?>new-salary" class="btn btn-primary"><em class="icon ni ni-plus"></em></a>
                                    </li>
                                <?php } ?>
                            </ul>
                        </div>
                ...
                <form action="" method="post" class="form-validate is-alter" enctype="multipart/form-data">
                    <div class="form-group">
                        <div class="form-control-wrap">
                            <input type="text" class="form-control form-control-lg" name="search_salary" value="<?php if(!empty($sessionSalary)){ echo $sessionSalary; } ?>" placeholder="Search..." autocomplete="off">
        ...
        <?php if(!empty($this->session->userdata('session_salary_trash_success'))){ ?>
            <div class="alert alert-success alert-icon">
                <em class="icon ni ni-alert-circle"></em> 
                <?php echo $this->session->userdata('session_salary_trash_success'); $this->session->unset_userdata('session_salary_trash_success'); ?>
            </div>
        <?php } ?>
        
        <?php if(!empty($this->session->userdata('session_salary_email_success'))){ ?>
            <div class="alert alert-success alert-icon">
                <em class="icon ni ni-alert-circle"></em> 
                <?php echo $this->session->userdata('session_salary_email_success'); $this->session->unset_userdata('session_salary_email_success'); ?>
            </div>
        <?php } ?>
        
        <?php if(!empty($this->session->userdata('session_salary_email_error'))){ ?>
            <div class="alert alert-danger alert-icon">
                <em class="icon ni ni-alert-circle"></em> 
                <?php echo $this->session->userdata('session_salary_email_error'); $this->session->unset_userdata('session_salary_email_error'); ?>
            </div>
        <?php } ?>
                                    ...
                                    <?php if($isSalaryView){ ?>
                                        <?php if(!empty($viewSalary)){ ?>
                                            <tbody>
                                                ...
                                                <tr class="tb-tnx-item">
                                                    ...
                                                    <td class="nk-tb-col">
                                                        <div class="user-card">
                                                            ...
                                                            <?php } ?>
                                                            <a href="<?php echo base_url(); ?>detail-salary/<?php echo urlEncodes($data['salary_id']); ?>">
                                                    ...
                                                    <td class="nk-tb-col nk-tb-col-tools">
                                                        <ul class="nk-tb-actions gx-1">
                                                            <?php if($isSalaryEmailEdit){ ?>
                                                                <?php if($data['employeeData']['employee_status'] == 'active'){ ?>
                                                                    <li class="nk-tb-action">
                                                                        <a data-bs-toggle="modal" data-bs-target="#emailModal<?php echo urlEncodes($data['salary_id']);?>" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Send Email">
                                                            ...
                                                            <?php if($isSalaryEdit){ ?>
                                                                <?php if($data['employeeData']['employee_status'] == 'active'){ ?>
                                                                    <li class="nk-tb-action">
                                                                        <a href="<?php echo base_url(); ?>edit-salary/<?php echo urlEncodes($data['salary_id']); ?>" class="btn btn-trigger btn-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
                                                            ...
                                                            <?php if(!empty($this->session->userdata['user_role'])){ ?>
                                                                <?php if($this->session->userdata['user_role'] == "Super"){ ?>
                                                                    <li class="nk-tb-action">
                                                                        <a data-bs-toggle="modal" data-bs-target="#trashModal<?php echo urlEncodes($data['salary_id']);?>" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Trash">
                                                ...
                                                <div class="modal fade" tabindex="-1" id="emailModal<?php echo urlEncodes($data['salary_id']);?>">
                                                    <div class="modal-dialog modal-dialog-top" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title">Email Salary</h5>
                                                            ...
                                                            <div class="modal-footer bg-light">
                                                                <span class="sub-text"><a href="<?php echo base_url(); ?>email-salary/<?php echo urlEncodes($data['salary_id']); ?>" class="btn btn-sm btn-success submitBtn">Send</a></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="modal fade" tabindex="-1" id="trashModal<?php echo urlEncodes($data['salary_id']);?>">
                                                    <div class="modal-dialog modal-dialog-top" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title">Trash Salary</h5>
                                                                <a href="<?php echo $_SERVER['REQUEST_URI']; ?>" class="close" data-bs-dismiss="modal" aria-label="Close">
                                                                    <em class="icon ni ni-cross"></em>
                                                                </a>
                                                            </div>
                                                            ...
                                                            <div class="modal-footer bg-light">
                                                                <span class="sub-text"><a href="<?php echo base_url(); ?>trash-salary/<?php echo urlEncodes($data['salary_id']); ?>" class="btn btn-sm btn-warning submitBtn">Trash</a></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
<script>
    document.getElementById('search-email').addEventListener('change', function() {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: { search_salary_email: selectedEmail },
            success: function() {
...
<script>
    document.getElementById('search-type').addEventListener('change', function() {
        ...
        $.ajax({
            url: '<?= base_url('view-salary'); ?>',
            type: 'POST',
            data: { search_salary_type: selectedType },
            success: function() {
                window.location.href=window.location.href;
            }
        });
...
<script>
    document.getElementById('search-status').addEventListener('change', function() {
        ...
        $.ajax({
            url: '<?= base_url('view-salary'); ?>',
            type: 'POST',
            data: { search_salary_status: selectedStatus },
            success: function() {
                window.location.href=window.location.href;
            }
        });
