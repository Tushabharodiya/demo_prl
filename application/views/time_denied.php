                        ...
                        <div class="card card-bordered">
                            <div class="card-inner card-inner-lg">
                                <div class="nk-block-content nk-error-ld text-center">
                                    <h1 class="nk-error-head"><em class="icon ni ni-clock"></em></h1>
                                    <h3 class="nk-error-title">Your Time is Overed!</h3>
                                    <p class="nk-error-text">Login not allowed for this user at the current time.</p>
                                </div>
                            </div>
                        </div>
                    </div>
