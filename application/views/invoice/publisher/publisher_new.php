                    ...
                    <div class="row g-gs">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" name="publisher_address" placeholder="Enter publisher address" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" name="publisher_gst_number" placeholder="Enter publisher gst number" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
