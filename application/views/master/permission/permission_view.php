            ...
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    ...
                    <div class="nk-block-des text-soft">
                        <p><?php echo "You have total $countPermission permissions."; ?></p>
                    </div>
                </div>
                <div class="nk-block-head-content">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="filter-wg dropdown-menu dropdown-menu-md dropdown-menu-end">
                                                <div class="dropdown-head">
                                                    <span class="sub-title dropdown-title">Filter Permission</span>
                                                </div>
                                                    ...
                                                    <div class="row gx-6 gy-3">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control form-select" id="search-status" name="search_permission_status" data-placeholder="Select a status">
                                                                    <?php $str='';
                                                                        if(!empty($sessionPermissionStatus == 'all')){
                                                                            $str.='selected';
                                                                    } ?> <option value="all"<?php echo $str; ?>>All</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionPermissionStatus == 'true')){
                                                                            $str.='selected';
                                                                    } ?> <option value="true"<?php echo $str; ?>>True</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionPermissionStatus == 'false')){
                                                                            $str.='selected';
            ...
            <form action="" method="post" class="form-validate is-alter" enctype="multipart/form-data">
                <div class="form-group">
                    <div class="form-control-wrap">
                        <input type="text" class="form-control form-control-lg" name="search_permission" value="<?php if(!empty($sessionPermission)){ echo $sessionPermission; } ?>" placeholder="Search..." autocomplete="off">
                    ...
                    <div class="card-inner p-0">
                        <div class="table-responsive">
                            <table class="table table-tranx">
                                ...
                                <?php if(!empty($viewPermission)){ ?>
                                    <tbody>
                                        <?php foreach($viewPermission as $data){ ?>
                                        <tr class="tb-tnx-item">
                                            <td class="nk-tb-col">
                                                <span class="sub-text"><?php echo $data['permission_position']; ?></span>
                                            </td>
                                            <td class="nk-tb-col">
...
<script>
    document.getElementById('search-status').addEventListener('change', function() {
        ...
        $.ajax({
            url: '<?= base_url('view-permission'); ?>',
            type: 'POST',
            data: { search_permission_status: selectedStatus },
            success: function() {
