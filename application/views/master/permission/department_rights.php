            ...
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    ...
                    <div class="nk-block-des text-soft">
                        <p><?php echo $departmentData['department_name']; ?> - Department Rights</p>
                    </div>
                </div>
                <div class="nk-block-head-content">
                                                                ...
                                                                <tr class="nk-tb-item">
                                                                    ...
                                                                    <td class="nk-tb-col nk-tb-col-check">
                                                                        <div class="custom-control custom-control-sm custom-checkbox ">
                                                                            ...
                                                                            <?php foreach($departmentPermissionData as $row){ if($row['permission_alias'] == $data['permission_alias']){ echo "checked"; } } ?> >
                                                                            <label class="custom-control-label" for="<?php echo $data['permission_id']; ?>"></label>
                                                                        </div>
                                                                    </td>
                                                                    <td class="nk-tb-col">
                                                                        <div class="user-info">
                                                                            <span class="title"><?php echo $data['permission_name']; ?></span>
